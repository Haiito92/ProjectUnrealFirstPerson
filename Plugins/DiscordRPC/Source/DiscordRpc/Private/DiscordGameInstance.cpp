...
{
	SetDiscordPresenceWithTimestampOption(PresenceState, true);
}

void UDiscordGameInstance::SetDiscordPresenceWithTimestampOption(EDiscordPresenceState PresenceState, bool ResetTimestamp)
{
	...
	StampRef = ResetTimestamp ? DiscordRpc->GetStartTimeStamp() : DiscordRpc->RichPresence.startTimestamp;
